...
bool in_left_triangle(vec2 p) {
    ...
    vec2 vertex1 = vec2(prog, 0.5);
    vec2 vertex2 = vec2(0.0, 0.5 - prog);
    vec2 vertex3 = vec2(0.0, 0.5 + prog);
    return PointInTriangle(p, vertex1, vertex2, vertex3);
}

bool in_right_triangle(vec2 p) {
    float prog = clamp(progress, 0.0, 1.0);
    vec2 vertex1 = vec2(1.0 - prog, 0.5);
    vec2 vertex2 = vec2(1.0, 0.5 - prog);
    vec2 vertex3 = vec2(1.0, 0.5 + prog);
    return PointInTriangle(p, vertex1, vertex2, vertex3);
}
