...
bool in_left_triangle(vec2 p){
  ...
  vertex1 = vec2((progress * progress), 0.5);
  vertex2 = vec2(0.0, 0.5-(progress * progress));
  vertex3 = vec2(0.0, 0.5+(progress * progress));
...
bool in_right_triangle(vec2 p){
  vec2 vertex1, vertex2, vertex3;
  vertex1 = vec2(1.0-(progress * progress), 0.5);
  vertex2 = vec2(1.0, 0.5-(progress * progress));
  vertex3 = vec2(1.0, 0.5+(progress * progress));
  if (PointInTriangle(p, vertex1, vertex2, vertex3))
  {
    return true;
  }
