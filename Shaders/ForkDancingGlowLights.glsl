...
// Original author: QuantumSuper
// Modified by: ArthurTent for ShaderAmp project
// URL: https://www.shadertoy.com/view/DtsBWH
...
// iFrame not available in OneOffRender - approximate with time
#define iFrame vec2(iTime * 60.0)
