...
// Original author: zhonkvision
// Modified by: ArthurTent for ShaderAmp project
// URL: https://www.shadertoy.com/view/DtlBW7
...
void main( )
{
    ...
    vec3 col_greenscreen = 0.3+ getTexture((fragCoord / iResolution));
    ...
    fragColor *= vec4(col_greenscreen,1.0);
}
