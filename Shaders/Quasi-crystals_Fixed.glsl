...
void main() {
    ...
    float hue = intensity * 2.0 + iTime * 0.1;
    float saturation = 0.8 + 0.2 * sin(r * 5.0);
    float value = 0.95;//0.5 + 0.5 * intensity;
