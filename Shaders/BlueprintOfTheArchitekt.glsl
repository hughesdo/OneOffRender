...
// URL: https://www.shadertoy.com/view/4tySDW
...
void main() {
	...
	vec2 mouse = (iResolution.xy * 0.5) / iResolution.xy * 2. - 1.;
    ...
    //} else {
        ...
        rot = vec2(
            ...
            mix(sin(iTime * SPEED) * PI / 8., PI / 2. - 1e-5, saturate2(exp(-iTime + 10.5))));
    //}
    ...
    */
    ...
    // gamma correction
    fragColor = pow(saturate2(fragColor), vec4(1. / 2.2)) * step(abs(uv.y), 1.);
}
