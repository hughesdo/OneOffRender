...
// Original author: willis
// Modified by: ArthurTent for ShaderAmp project
// URL: https://www.shadertoy.com/view/wtyfzV
...
void main()
{
    ...
    fragCoord.y = iResolution.y - fragCoord.y;
        ...
        vec2 uv = ((fragCoord / iResolution) - 0.5) * 2.0;
    vec2 oriUV = uv;
    
    float fft1 = texelFetch(iChannel0, ivec2(0., 1.), 0).x ;
    ...
    float fft2 = texelFetch(iChannel0, ivec2(0.7, 0.), 0).x ;
