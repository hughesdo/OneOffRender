...
// Original author: Dave_Hoskins
// Modified by: ArthurTent for ShaderAmp project
// URL: https://www.shadertoy.com/view/MdXSzS
...
void main()
{
	...
	vec2 uv = (fragCoord / iResolution) - .5;
	...
	vec3 col = vec3( v3 * (1.5 + sin(iTime * .2) * .4*sample_at(0.51)),
