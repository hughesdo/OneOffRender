...
/*
    CRYSTALLINE VOID - Audio Reactive Fractal Flythrough (Close Orb Version)
    =========================================================================
    ...
    - CLOSE ORB VERSION: Gyroid orb stays closer to camera for better visibility
...
vec3 getOrbPosition(float t) {
    // Follow the camera path but offset ahead (REDUCED from 1.5 to 0.7 for closer view)
    vec3 pathPos = camPath(t + 0.7);
