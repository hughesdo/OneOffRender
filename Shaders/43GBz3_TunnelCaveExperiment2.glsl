...
// Tunnel Cave Experiment 2
// Created by diatribes
// Shadertoy ID: 43GBz3
// https://www.shadertoy.com/view/43GBz3
...
vec3 path1(float z) {
    return vec3(
        tan(cos(z * .001) * 1.3)+(cos(z * .11) * 1.5) * 1., 
        sin(sin(z * .1)) * 6.3,
        z
    );
}
