...
vec4 plane(vec3 ro, vec3 rd, vec3 pp, vec3 off, float aa, float n) {
    ...
    // thanks to Tristan Cacqueray for the idea
    // https://gitlab.com/TristanCacqueray/animation-fractal/-/blob/main/src/Demo/Truchet.glsl
    vec3 col = mix(palette2(d + snd), vec3(0.0), smoothstep(aa, -aa, d));
