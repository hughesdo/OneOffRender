...
uniform sampler2D iChannel2;  // Image texture
...
float Map(vec3 pos)
{
    ...
    float fft = textureLod( iChannel0, vec2(0.5,0.15), 0.0).x;
...
void main()
{
    ...
    vec2 uv2 = (fragCoord / iResolution-0.5)  / camZoom;
