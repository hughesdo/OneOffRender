...
void main(){
    ...
    fragCoord.y = iResolution.y - fragCoord.y;
  	...
  	vec2 mouse = (iResolution.xy * 0.5).xy;

  	//vec2 aspect = vec2(iResolution.x / iResolution.y, 1.);
    vec2 aspect = -1.0 + 2.0 *fragCoord / iResolution;

    //vec2 screenCoord = (2. * fragCoord.xy / iResolution.xy - 1.) * aspect;
    //vec2 screenCoord = (2. * fragCoord / iResolution.xy / iResolution.xy - 1.) * aspect;
    vec2 screenCoord = (fragCoord / iResolution.xy / iResolution.xy - 1.) * aspect;
