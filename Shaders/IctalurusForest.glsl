...
// Original author: Nimajamin
// Modified by: ArthurTent for ShaderAmp project
// URL: https://www.shadertoy.com/view/MsVSWK
// License: MIT
...
void main()
{
    ...
    vec2 uv = fragCoord / iResolution; //-1. + 2. * vUv;
...
//  vec3 s = smoothstep(-0.01, 0.01, spline-uv.y); color += (1.0-s) * s;
	...
	float a1 = 0.15 + mouse.x / iResolution.x * 2.0;
	float a2 = 0.8 + mouse.y / iResolution.y * 2.0;
